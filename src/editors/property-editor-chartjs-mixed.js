...
export default class PropertyEditorChartJSMixed extends PropertyEditorChartJSAbstract {
  ...
  editorTemplate(props) {
    return html`
      ...
      <label>
        <things-i18n-msg msgid="label.stacked">Stacked</things-i18n-msg>
      </label>
      
      <input type="checkbox" value-key="multiAxis" checked=${this.multiAxis}>
      <label>
        <things-i18n-msg msgid="label.multi-axis">Multi Axis</things-i18n-msg>
      </label>
      
      <legend>
        <things-i18n-msg msgid="label.series">Series</things-i18n-msg>
      </legend>
      ...
      <div fullwidth>
        ...
        <div class="tab-content">
          <label>
            <things-i18n-msg msgid="label.data-key">Data Key</things-i18n-msg>
          </label>
          <input type="text" value-key="series.dataKey" value=${this.series.dataKey}>
      
          ${ this.value.type == 'bar' ? html`
            <label>
              <things-i18n-msg msgid="label.type">type</things-i18n-msg>
            </label>
          ...
          <label>
            <things-i18n-msg msgid="label.label">label</things-i18n-msg>
          </label>
          <input type="text" value-key="series.label" value=${this.series.label}>
      
          ${ this.series.type == 'line' ? html`
            <label>
              <things-i18n-msg msgid="label.line-tension">line tension</things-i18n-msg>
            </label>
          ...
          ${ this.series.type == 'line' ? html`
            <label>
              <things-i18n-msg msgid="label.border-color">border color</things-i18n-msg>
            </label>
            <things-editor-color value-key="series.borderColor" value=${this.series.borderColor}></things-editor-color>
            <label>
              <things-i18n-msg msgid="label.border-width">border width</things-i18n-msg>
            </label>
            <input type="number" value-key="series.borderWidth" value=${this.series.borderWidth}>
          `: html``}
      
          <label>
            <things-i18n-msg msgid="label.background-color">background color</things-i18n-msg>
          </label>
          <things-editor-color value-key="series.backgroundColor" value=${this.series.backgroundColor}></things-editor-color>
      
          ${ this.series.type == 'line' ? html`
            <label>
              <things-i18n-msg msgid="label.point-shape">point shape</things-i18n-msg>
            </label>
            ...
            <label>
              <things-i18n-msg msgid="label.point-size">point size</things-i18n-msg>
            </label>
            ...
            <things-editor-color value-key="series.pointBackgroundColor" value=${this.series.pointBackgroundColor}></things-editor-color>
          `: html``}
      
          ${ this.series.type == 'line' ? html`
            <input type="checkbox" value-key="series.fill" checked=${this.series.fill}>
            <label>
              <things-i18n-msg msgid="label.fill">fill</things-i18n-msg>
            </label>
          `: html``}
      
          <label>
            <things-i18n-msg msgid="label.target-axis">target axis</things-i18n-msg>
          </label>
          ...
          <label>
            <things-i18n-msg msgid="label.value-prefix">Value Prefix</things-i18n-msg>
          </label>
          <input type="text" value-key="series.valuePrefix" value=${this.series.valuePrefix}>
      
          <label>
            <things-i18n-msg msgid="label.value-suffix">Value suffix</things-i18n-msg>
          </label>
          ...
          <label>
            <things-i18n-msg msgid="label.value-display">Value Display</things-i18n-msg>
          </label>
      
          ${ this.series.displayValue ? html`
            <label>
              <things-i18n-msg msgid="label.font-color">Font Color</things-i18n-msg>
            </label>
            <things-editor-color value-key="series.defaultFontColor" value=${this.series.defaultFontColor}></things-editor-color>
            <label>
              <things-i18n-msg msgid="label.font-size">Font Size</things-i18n-msg>
            </label>
            <input type="number" value-key="series.defaultFontSize" value=${this.series.defaultFontSize}>
          `: html``}
      
          ${ !this.data.datasets || this.data.datasets.length != 1 ? html`
      ...
      <legend>
        <things-i18n-msg msgid="label.x-axes">X Axes</things-i18n-msg>
      </legend>
      ...
      <label>
        <things-i18n-msg msgid="label.title">Title</things-i18n-msg>
      </label>
      <input type="text" value-key="xAxes0.axisTitle" value=${this.xAxes0.axisTitle}>
      
      <label>
        <things-i18n-msg msgid="label.thickness">Thickness</things-i18n-msg>
      </label>
      ...
      <label>
        <things-i18n-msg msgid="label.grid-line">Grid Line</things-i18n-msg>
      </label>
      
      <input type="checkbox" value-key="xAxes0.ticks.display" checked=${this.xAxes0.ticks.display}>
      <label>
        <things-i18n-msg msgid="label.display-tick">Display Tick</things-i18n-msg>
      </label>
      
      
      <legend>
        <things-i18n-msg msgid="label.y-axes">Y Axes</things-i18n-msg>
      </legend>
      ...
      <label>
        <things-i18n-msg msgid="label.axis-min-auto">Min Auto</things-i18n-msg>
      </label>
      
      <input type="checkbox" value-key="yAxes0.ticks.autoMax" checked=${this.yAxes0.ticks.autoMax}>
      <label>
        <things-i18n-msg msgid="label.axis-max-auto">Max Auto</things-i18n-msg>
      </label>
      
      ${ !this.yAxes0.ticks.autoMin ? html`
        <label>
          <things-i18n-msg msgid="label.axis-min">Min</things-i18n-msg>
        </label>
        <input type="number" value-key="yAxes0.ticks.min" value=${this.yAxes0.ticks.min}>
      `: html``
      }
      
      ${ !this.yAxes0.ticks.autoMax ? html`
        <label>
          <things-i18n-msg msgid="label.axis-max">Max</things-i18n-msg>
        </label>
      ...
      <label>
        <things-i18n-msg msgid="label.axis-step-size">StepSize</things-i18n-msg>
      </label>
      ...
      ${ props.value.options.multiAxis ? html`
        <legend>
          <things-i18n-msg msgid="label.y-2nd-axes">Y 2nd Axes</things-i18n-msg>
        </legend>
        ...
        ${ !this.yAxes1.ticks.autoMin ? html`
          <label>
            <things-i18n-msg msgid="label.axis-min">Min</things-i18n-msg>
          </label>
        ...
        ${ !this.yAxes1.ticks.autoMax ? html`
          <label>
            <things-i18n-msg msgid="label.axis-max">Max</things-i18n-msg>
          </label>
        ...
        <input type="checkbox" value-key="value.options.y2ndGridLine" checked=${props.value.options.y2ndGridLine}>
        <label>
          <things-i18n-msg msgid="label.grid-line">Grid Line</things-i18n-msg>
        </label>
